...
TEST_NAME = 'Cells_expl_01_sStack-10.tif'
...
# Open data
raw = io.imread(TRAIN_PATH + RAW_NAME)
test = io.imread(DATA_PATH + TEST_NAME) 
mask = io.imread(TRAIN_PATH + MASK_NAME)
...
# Train the network
results = unet.fit(raw, mask, 
    validation_split=0.1, batch_size=16, epochs=100, callbacks=callbacks)
